			...
			<div class="login-wrapper">
				<div class="box">
						...
						<legend> Ajouter un nouveau produit </legend>
							<form method="post" action="index.php?uc=produit&action=ajouterP">
                                                            <input name="nom" class="form-control" type="text" placeholder="nom du produit"/>
                                                            <input name="objectif" class="form-control" type="text" placeholder="objectif du produit"/>
                                                            <input name="info" class="form-control" type="text" placeholder="information du produit"/>
                                                            <input name="effet" class="form-control" type="text" placeholder="effets indésirable"/>
								<br>
