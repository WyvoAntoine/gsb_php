		...
		<div class="col-md-4 col-md-offset-4">
			<div class="login-wrapper">
				<div class="box">
						...
						<legend>Entrer les informations de la visio : </legend>
							<form method="post" action="index.php?uc=visio&action=creationOk">
                                                            
							    
                                                            <p style='font-size:15px'>Entrer le nom de la visio :</p>
                                                            <input name="nomVisio" class="form-control" type="text" placeholder="Entrer le nom ici !"/><br/>
                                                            
                                                            <br/>
                                                            <p style='font-size:15px'>Entrer l'objectif de la visio :</p>
                                                            <input name="objectifVisio" class="form-control" type="text" placeholder="Entrer l'objectif de la visio ici !"/><br/>
                                                            
                                                           <p style='font-size:15px'>Entrer l'url de la visio : </p> 
                                                           <input name="urlVisio" class="form-control" type="text" placeholder="Entrer l'url de la visio ici !"/><br/>
                                                            
                                                           <p style='font-size:15px'>Entrer la date de la visio : </p> 
                                                           <input name="dateVisio" class="form-control" type="date"/><br/>
