	...
	<div class="row">
		<div class="col-md-10 col-md-offset-0">
			<div class="login-wrapper">
				<div class="box">
                                    <legend>Details de la visio :</legend>
                                    ...
                                    <h6><?php
                                         foreach ($tab as $visioDetails){
                                             echo 'Nom : '.$visioDetails['nomVisio'].'<br/>'.'<br/>'.
                                              'Objectif : '.$visioDetails['objectif'].'<br/>'.'<br/>'.
                                                     'URL : '.$visioDetails['url'].'<br/>'.'<br/>'
                                                     . 'Date : '.$visioDetails['dateVisio'].'<br/>'.'<br/>';
                                             
                                         }
                                        ?>
                                        <a class="btn btn-primary" href="index.php?uc=visio&action=modifVisio&id=<?php echo $id ?>">Modifier</a>
                                        <a class="btn btn-primary" href="index.php?uc=visio&action=supprimer&id=<?php echo $id ?>">Supprimer</a>
