	...
	<div class="row">
		<div class="col-md-6 col-md-offset-2">
			<div class="login-wrapper">
				<div class="box">
                                    <legend>Configuration Visio :</legend>
                                    <form>
                                        <a href="index.php?uc=visio&action=creationvisio">
                                        <input type="button" value="Créer une visio"><br/><br/>
                                        <a href="index.php?uc=visio&action=demandeVisio">
                                        <input type="button" value="Modifier une visio"><br/><br/>
                                        <a href="index.php?uc=visio&action=demandeVisio">
                                        <input type="button" value="Supprimer une visio">
                                        </a>
</form>
  </div>
</nav>
