  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="index.php?uc=droit&action=demandeModification">Modifer compte</a></li>
	...
	<div class="row">
		<div class="col-md-10 col-md-offset-0">
			<div class="login-wrapper">
				<div class="box">
                                    <legend>Les différentes Visio :</legend>
                                    
                                    <?php
                                        $pdo= PdoGsb::getPdoGsb();
                                        $estConnecte= estConnecte();
                                        $tab= PdoGsb::listeVisio();
                                     ?>
                                    
                                    <h6><?php
                                         foreach ($tab as $visio){
                                             echo $visio['nomVisio']." | ";
                                         
                                        ?>
                                        <a href="index.php?uc=visio&action=detailsVisio&id=<?php echo $visio['id']?>">Details</a><br/><br/>
                                         <?php }?>
                                        </h6>                                    
                                </div>
                        </div>
