  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="index.php?uc=droit&action=demandeModification">Modiifer son compte</a></li>
        <li class="active"><a href="index.php?uc=produit&action=selectProduit">Les produits</a></li>
        <li class="active"><a href="index.php?uc=maintenance&action=selectmaintenance">Parametre du site</a></li>
