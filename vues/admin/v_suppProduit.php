...
<nav class="navbar navbar-default">
  <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="index.php?uc=modifier&action=demandeModification">Modifier compte</a></li>
						...
						<legend>Les produits</legend>
							<?php 
                                                 ...
                                                 <h6> <?php  
                                                     ...
                                                     <a class="btn btn-primary signup" href="index.php?uc=produit&action=supp&id=<?php echo $produit['id']?>">Supprimer le produit</a>
                                                 </h6>
