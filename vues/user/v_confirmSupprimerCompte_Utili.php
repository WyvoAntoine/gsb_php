		...
		<div class="col-md-4 col-md-offset-4">
			<div class="login-wrapper">
				<div class="box">
						...
						<legend>Êtes-vous sûr de vouloir supprimer votre compte ? </legend>
							<a class="btn btn-primary" href="index.php?uc=droit&action=supprimerDef&id=<?php $_SESSION['id'] ?>">Oui</a>
                                                        <a class="btn btn-primary" href="index.php?uc=droit&action=demandeSuppression&id=<?php $_SESSION['id'] ?>">Non</a>
