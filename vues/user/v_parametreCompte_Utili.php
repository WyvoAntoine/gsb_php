			...
			<div class="login-wrapper">
				<div class="box">
						...
						<legend>Choisissez ce que vous voulez faire : </legend>
							<a class="btn btn-primary" href="index.php?uc=droit&action=demandeModification&id=<?php $_SESSION['id'] ?>">Modifier compte</a><br/><br/>
                                                        <a class="btn btn-primary" href="index.php?uc=droit&action=demandeSuppression&id=<?php $_SESSION['id'] ?>">Supprimer compte</a><br/><br/>
                                                        <a class="btn btn-primary" href="index.php?uc=droit&action=json&id=<?php $_SESSION['id'] ?>">Télécharger vos données en JSON</a>
