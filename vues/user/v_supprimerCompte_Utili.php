			...
			<div class="login-wrapper">
				<div class="box">
						...
						<legend>Choisissez ce que vous voulez faire : </legend>
							<a class="btn btn-primary" href="index.php?uc=droit&action=confirmSupDef&id=<?php $_SESSION['id'] ?>">Supprimer définitivement compte</a><br/><br/>
                                                        <a class="btn btn-primary" href="index.php?uc=droit&action=confirmArchivage&id=<?php $_SESSION['id'] ?>">Archiver compte</a>
